...
/* BackendAdminBundle:Client:edit.html.twig */
class __TwigTemplate_92d8de81e8dadc3e18ba2f57fe70c9c1 extends Twig_Template
{
    protected $parent;
...
<form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("client_update", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "BackendAdminBundle:Client:edit.html.twig";
    }
