...
/* BackendAdminBundle:Vols:edit.html.twig */
class __TwigTemplate_9f61c0a4dd0e3271bdd04b78add7d6c1 extends Twig_Template
{
    protected $parent;
    ...
    {
        // line 4
        echo "<h1>Vols edit</h1>

<form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("vols_update", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "BackendAdminBundle:Vols:edit.html.twig";
    }
