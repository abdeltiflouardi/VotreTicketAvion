    ...
    <div class=\"sidebar-right\">
        ...
        if (($this->getAttribute($this->getContext($context, 'departure'), "nbResults", array(), "any", false) > 0)) {
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['vols']) {
                ...
                // line 47
                echo (($this->getAttribute((($this->getAttribute((($this->getAttribute(((array_key_exists("vols", $context)) ? (twig_default_filter($this->getContext($context, 'vols'))) : ("")), "tarifs", array(), "any", true)) ? (twig_default_filter($this->getAttribute($this->getContext($context, 'vols'), "tarifs", array(), "any", false))) : ("")), 0, array(), "array", true)) ? (twig_default_filter($this->getAttribute($this->getAttribute($this->getContext($context, 'vols'), "tarifs", array(), "any", false), 0, array(), "array", false))) : ("")), "tarifAdulte", array(), "any", true)) ? (twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, 'vols'), "tarifs", array(), "any", false), 0, array(), "array", false), "tarifAdulte", array(), "any", false), "&nbsp;")) : ("&nbsp;"));
                echo " ";
                echo twig_escape_filter($this->env, $this->env->getExtension('output')->getParam("currency"), "html");
                echo "</span>
                            </li>
